...
echo xrandr --output "${INT}" --auto --pos ${off_w}x${ext_h} --scale 1x1  --output "${EXT}" --auto --scale 2x2 --pos 0x0
xrandr --output "${INT}" --auto --pos ${off_w}x${ext_h} --scale 1x1  --output "${EXT}" --auto --scale 2x2 --pos 0x0

# xrandr --output eDP-1 --auto --pos 0x2160 --scale 1x1 --output HDMI-1 --auto --scale 1.5x1.5 --pos 0x0
