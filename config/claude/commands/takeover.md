...
Don't modify progress.md during this session. This file is only written at the end of a session during handover. Read it for context but leave it unchanged throughout your work.
