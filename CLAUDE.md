...
- Each folder in `skills/` -> immutable store-backed `~/.claude/skills/<skill>`, `~/.pi/agent/skills/<skill>`, and `~/.codex/skills/<skill>` according to the per-agent selection in `nix/lib/agent-skills.nix`
