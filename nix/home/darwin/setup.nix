...
in
{
  ...
  home.activation.setMacOSDefaults = hmLib.dag.entryAfter [ "writeBoundary" ] ''
    ...
    $DRY_RUN_CMD defaults write com.apple.screencapture location ~/Screenshots
    ...
    $DRY_RUN_CMD defaults write NSGlobalDomain InitialKeyRepeat -int 10

    # Finder behavior
    $DRY_RUN_CMD defaults write com.apple.finder QuitMenuItem -bool true
    $DRY_RUN_CMD defaults write com.apple.finder DisableAllAnimations -bool true
    $DRY_RUN_CMD defaults write com.apple.finder NewWindowTargetPath -string "file://$HOME/Downloads/"
    ...
    $DRY_RUN_CMD defaults write com.apple.finder WarnOnEmptyTrash -bool false

    # Show Library folder
    $DRY_RUN_CMD chflags nohidden ~/Library 2>/dev/null || true

    # Dock settings
    $DRY_RUN_CMD defaults write com.apple.dock minimize-to-application -bool true
    $DRY_RUN_CMD defaults write com.apple.dock mru-spaces -bool false
    ...
    $DRY_RUN_CMD defaults write com.apple.SoftwareUpdate ScheduleFrequency -int 1
    ...
    $DRY_RUN_CMD defaults write com.apple.commerce AutoUpdate -bool true

    # Menu bar clock format
    $DRY_RUN_CMD defaults write com.apple.menuextra.clock DateFormat -string "yyyy-MM-dd HH:mm"
